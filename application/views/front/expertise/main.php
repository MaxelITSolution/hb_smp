...
-->
                            <li><a href="<?php echo site_url('expertise'); ?>">ENG</a></li>
                            <li><a href="<?php echo site_url('ina/expertise'); ?>">INA</a></li>
                            <li><a href="<?php echo site_url('chn/expertise'); ?>">CHN</a></li>
                            <li><a href="<?php echo site_url('kor/expertise'); ?>">KOR</a></li>
                            <li><a href="<?php echo site_url('rus/expertise'); ?>">RUS</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
