	...
	<section class="datagrid-panel">
		...
		<section class="tile">
			<div class="tile-widget">
				<div class="row">
					<div class="col-sm-5">
						<button class="btn btn-sm btn-default" onclick="main_routes('create', '')"><i class="fa fa-plus"></i> New Post</button>
					</div>
...
<script type="text/javascript">
	...
	function create_update_form(rowIndex) {
		...
		$.post("<?php echo site_url('app/post/form'); ?>", {index : rowIndex}).done(function(data) {
