<div class="pageheader">
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><a data-url="<?php echo site_url('app/slideshow'); ?>" href="javascript:;" onclick="load_content(this)">Slideshow</a></li>
			    ...
			    <div class="tile-body">
					...
					<div class="form-group">
						<div class="col-sm-12">
							...
							<div class="validation-message" data-field="caption"></div>
						</div>
					</div>
...
<script type="text/javascript">
	...
	function validate(formData) {
		...
		$.ajax({
	        url: "<?php echo site_url('app/slideshow/validate'); ?>", async: false, type: 'POST', data: formData,
	...
	function save(formData, images) {
		...
		$.post("<?php echo site_url('app/slideshow/action'); ?>", formData).done(function(data) {
	...
	function upload_images() {
	    ...
	    $.ajax({
			url: "<?php echo site_url('app/slideshow/upload'); ?>",
			type: "POST",
			data: data,
			cache: false,
			dataType: "json",
