...
(function ( $ ) {
	...
	$.fn.datagrid = function(options) {
		...
		function PagingData(activePageNumber, itemsPerPage) {
			...
			temp += '<li ' + first_link_disabled + ' title="first"><a href="javascript:void(0);">First</a></li>';
			temp += '<li ' + first_link_disabled + ' title="prev"><a href="javascript:void(0);">Prev</a></li>';
			...
			temp += '<li ' + last_link_disabled + ' title="next"><a href="javascript:void(0);">Next</a></li>';
			temp += '<li ' + last_link_disabled + ' title="last"><a href="javascript:void(0);">Last</a></li>';
